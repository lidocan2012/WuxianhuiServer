	...
	AreaSelector.fn = AreaSelector.prototype = {
		init : function(setting) {
			...
			if (selector.onProvinceChange)
				gid(selector.selProvinceId).onchange = function() {
					this.selector.chgProvince.call(this,
							selector.onProvinceChange)
				};
			else
				gid(selector.selProvinceId).onchange = this.chgProvince;

			if (selector.onCityChange)
				gid(selector.selCityId).onchange = function() {
					this.selector.chgCity.call(this, selector.onCityChange)
				};
			else
		...
		resetOptions : function(domID, selLevel, data, value) {
			...
			switch (selLevel) {
			case 1:
				G.options[0] = new Option(this.setting.cityOptionText,
						this.setting.cityOptionValue);
				break;
			case 2:
				G.options[0] = new Option(this.setting.areaOptionText,
						this.setting.areaOptionValue);
				break;
			default:
				G.options[0] = new Option(this.setting.provinceOptionText,
						this.setting.provinceOptionValue);
				break;
			}
		...
		initProvince : function(ProvinceId, CityId, AreaId) {
			this.resetOptions(this.setting.selProvinceId, 0, this.setting.data,
					ProvinceId);
		...
		initCity : function(CityId, AreaId) {
			...
			if (index <= 0) {
				this.resetOptions(this.setting.selCityId, 1);
				return;
			}
		...
		initArea : function(AreaId) {
			...
			if (index <= 0) {
				this.resetOptions(this.setting.selAreaId, 2);
				return;
			}
